...
3. **안건 단위 검색** - 벡터 유사도 기반 시맨틱 검색
4. **Top 5 주목받는 안건** - 메인 페이지에 자동 표시
5. **안건 상세 페이지** - 핵심 의제, 발언자별 입장, 전체 텍스트 제공
6. **반응형 UI** - 모바일/데스크톱 대응 (Tailwind CSS, max-w-lg)
...
**Status**: 전체 파이프라인 구축 완료 (크롤링 → 파싱 → AI 요약 → 검색)
